...
CodeFile="Default.aspx.cs" Inherits="Pages_Sistema_Analista_EditarUsuario" %>
          ...
          <div class="row">
            ...
            <div class="col-10">
              ...
              <asp:TextBox
                ...
                placeholder="Insira o Cargo do usuario"
                TextMode="SingleLine"
                required
              />
              <asp:TextBox
              ...
              <asp:DropDownList
                ...
                runat="server"
                CssClass="form-control mt-3"
                placeholder="Departamento do Usuario"
                TextMode="SingleLine"
              >
                <asp:ListItem
                  Text="Escolha o Departamento do Usuario"
                  Disabled="true"
                  Selected="True"
                />
              ...
              <div class="row">
                <div class="col-md-6">
                  <asp:Button
                    ...
                    runat="server"
                    Text="Enviar"
                    CssClass="btn btn-primary w-100 mt-5 mb-2"
                    OnClick="btnUpdateUser_Click"
                  />
                </div>
                <div class="col-md-4">
                  <a
                    href="/Pages/Sistema/Analista/ListaColaboradores/Default.aspx"
                    class="btn mt-5 mb-2 w-100"
                    style="background-color: #dae9ff; color: #3381e2"
                  >
                    <b>Voltar Tab. Colaborador</b></a
                  >
                </div>
              </div>
            </div>
