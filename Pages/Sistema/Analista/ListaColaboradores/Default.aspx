<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Master/MasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Pages_Sistema_Analista_ListaColaboradores" %>
    ...
    <asp:UpdatePanel ID="upTables" runat="server" UpdateMode="Conditional">
      <ContentTemplate>
        ...
        <div class="row d-flex justify-content-between">
          ...
          <hr />
          <p class="fs-3 mb-5 text-primary">Tabela de Colaboradores</p>
        </div>
        <asp:Label ID="lblCdCollaborator" runat="server" />
        <div class="row">
          <div class="col-md-12">
            <div class="card mb-4">
              <div class="card-header bg-primary text-white"><i class="fa-solid fa-table me-1"></i> Colaboradores Ativos</div>
                  ...
                  <asp:GridView ID="gdvCollaboratorActive" OnRowCommand="gdvCollaboratorActive_RowCommand" runat="server" AutoGenerateColumns="false" CssClass="table table-hover datatable-plugin border-top-0 border-start-0 border-end-0">
                    <Columns>
                      ...
                      <asp:TemplateField HeaderText="Atualizar">
                        <ItemTemplate><asp:LinkButton ID="lbUpdate" runat="server" CommandName="Atualizar" CommandArgument='<%#Bind("user_id")%>'><i class="fa-solid fa-pen-to-square px-3 py-3"></i></asp:LinkButton></ItemTemplate>
                      </asp:TemplateField>
                      <asp:TemplateField HeaderText="Deletar">
                        <ItemTemplate><asp:LinkButton ID="lkbDeletarUser" runat="server" Text="" CommandName="Deletar" CommandArgument='<% #Bind("user_id") %>'><i class="fa-solid fa-user-slash px-3 py-3"></i></asp:LinkButton></ItemTemplate>
                      </asp:TemplateField>
                    </Columns>
                  </asp:GridView>
                </div>
            ...
            <div class="col-md-12">
              <div class="card mb-4">
                <div class="card-header bg-primary text-white"><i class="fa-solid fa-table me-1"></i> Colaboradores Inativos</div>
                <div class="card-body overflow-auto">
                  <div class="table-responsive p-3">
                    ...
                    <asp:GridView ID="gdvCollaboratorInactive" OnRowCommand="gdvCollaboratorInactive_RowCommand" runat="server" AutoGenerateColumns="false" CssClass="table table-hover datatable-plugin border-top-0 border-start-0 border-end-0">
                      <Columns>
                        ...
                        <asp:TemplateField HeaderText="Ativar">
                          <ItemTemplate><asp:LinkButton ID="lkbActiveUser" runat="server" Text="" CommandName="Ativar" CommandArgument='<% #Bind("user_id") %>'><i class="fa-solid fa-person-circle-plus px-3 py-3"></i></asp:LinkButton></ItemTemplate>
                        </asp:TemplateField>
                      </Columns>
                    </asp:GridView>
                  </div>
      ...
      <Triggers>
        <asp:AsyncPostBackTrigger ControlID="gdvCollaboratorActive" />
        <asp:AsyncPostBackTrigger ControlID="gdvCollaboratorInactive" />
        <asp:AsyncPostBackTrigger ControlID="btnCollaborator" />
      </Triggers>
    </asp:UpdatePanel>
