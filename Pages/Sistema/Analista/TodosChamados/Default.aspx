...
Inherits="Pages_Sistema_Analista_TodosChamados" %>
          ...
          <div class="col-md-12">
            <div class="card mb-4">
              <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                <span><i class="fa-solid fa-table me-1"></i>Todos Chamados</span>
                <div class="d-flex gap-2">
                  <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control form-control-sm" Placeholder="Buscar chamado..." />
                  <asp:LinkButton ID="btnSearch" runat="server" CssClass="btn btn-light btn-sm" OnClick="btnSearch_Click">
              ...
              <div class="card-body overflow-auto">
                <div class="table-responsive p-3">
                  ...
                  <asp:GridView
                    ...
                    OnPageIndexChanging="gdvTickets_PageIndexChanging"
                  >
                    <Columns>
                      ...
                      <asp:TemplateField HeaderText="Ações" ItemStyle-CssClass="py-4">
                        <ItemTemplate>
                          <a href='/Pages/Sistema/Analista/DetalheChamado/Default.aspx?id=<%# Eval("tic_id") %>' class="btn btn-sm btn-outline-info" title="Detalhes"><i class="fa-solid fa-eye"></i></a>
                        </ItemTemplate>
                      </asp:TemplateField>
                    </Columns>
                  </asp:GridView>
