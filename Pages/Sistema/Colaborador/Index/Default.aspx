<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Master/MasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Pages_Sistema_Colaborador_Index" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="upContent" runat="server" UpdateMode="Conditional">
      <ContentTemplate>
        ...
        <asp:Label ID="lblValidator" runat="server" />
        <div class="row d-flex justify-content-between">
          ...
          <hr />
          <p class="fs-3 mb-5 text-primary">Resumo</p>
        </div>
        <div class="container">
          <div class="row">
            <div class="col-md-4 my-1 d-flex justify-content-center">
              <div class="card w-75 text-center border-0 shadow pb-4">
                <div class="card-header border-0 mb-2 text-start bg-transparent"><i class="fa-regular fa-circle-question text-secondary"></i></div>
                <div class="d-flex justify-content-center">
                  <div class="rounded-circle bg-success-low" style="width:70px;height:70px"><i class="fa-solid fa-circle-check text-black-50 fs-6 mt-4"></i></div>
                </div>
                <div class="card-body">
                  <asp:Label class="card-title mt-3 fs-1" ID="lblFinishedCalls" runat="server" />
            ...
            <div class="col-md-4 my-1 d-flex justify-content-center">
              <div class="card w-75 text-center border-0 shadow pb-4">
                <div class="card-header border-0 mb-2 text-start bg-transparent"><i class="fa-regular fa-circle-question text-secondary"></i></div>
                <div class="d-flex justify-content-center">
                  <div class="rounded-circle bg-warning-low" style="width:70px;height:70px"><i class="fa-solid fa-clock text-black-50 fs-6 mt-4"></i></div>
                </div>
                <div class="card-body">
                  <asp:Label class="card-title mt-3 fs-1" ID="lblProgressCalls" runat="server" />
            ...
            <div class="col-md-4 my-1 d-flex justify-content-center">
              <div class="card w-75 text-center border-0 shadow pb-4">
                <div class="card-header border-0 mb-2 text-start bg-transparent"><i class="fa-regular fa-circle-question text-secondary"></i></div>
                <div class="d-flex justify-content-center">
                  <div class="rounded-circle bg-primary-low" style="width:70px;height:70px"><i class="fa-solid fa-spinner text-black-50 fs-6 mt-4"></i></div>
                </div>
                <div class="card-body">
                  <asp:Label class="card-title mt-3 fs-1" ID="lblOpenCalls" runat="server" />
        ...
        <div class="row mt-5">
          <div class="col-md-6">
            <div class="card mb-4">
              <div class="card-header bg-primary text-white"><i class="fa-solid fa-table me-1"></i> Todos os meus Chamados</div>
              <div class="card-body overflow-auto" style="height:400px">
                <div class="table-responsive p-3">
                  ...
                  <asp:GridView ID="gdvTickets" runat="server" AutoGenerateColumns="false" CssClass="table table-hover datatable-plugin border-top-0 border-start-0 border-end-0" OnRowDataBound="gdvTickets_RowDataBound" OnRowCommand="gdvTickets_RowCommand">
                    <Columns>
                      <asp:TemplateField HeaderText="Prioridade" ItemStyle-CssClass="py-4 text-black-50">
                        <ItemTemplate>
                      ...
                      <asp:TemplateField HeaderText="Ações" ItemStyle-CssClass="py-4">
                        <ItemTemplate>
                          ...
                          <asp:LinkButton ID="lkbRate" runat="server" CssClass="btn btn-sm btn-outline-warning" CommandName="Avaliar" CommandArgument='<%# Eval("tic_id") %>' Visible='<%# Convert.ToInt32(Eval("tic_status")) == 2 %>' title="Avaliar"><i class="fa-solid fa-star"></i></asp:LinkButton>
                        </ItemTemplate>
                      </asp:TemplateField>
                    </Columns>
                  </asp:GridView>
      ...
      <Triggers>
        <asp:AsyncPostBackTrigger ControlID="btnTicket" />
      </Triggers>
    </asp:UpdatePanel>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <asp:DropDownList ID="ddlPriority" runat="server" CssClass="form-control mt-3">
                        <asp:ListItem Text="Prioridade Normal" Value="0" />
                        <asp:ListItem Text="Prioridade Alta" Value="1" />
                        <asp:ListItem Text="Prioridade Urgente" Value="2" />
                    </asp:DropDownList>
                    <asp:DropDownList ID="ddlEquip" runat="server" CssClass="form-control mt-3">
                        <asp:ListItem Text="Selecione um equipamento" Value="0" Selected="True" />
                    </asp:DropDownList>
